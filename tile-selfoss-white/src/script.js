...
const tileConfigurations = {
  "1200x600": [1, 1, 0, 0], // Kolejno: polished, lappato, matt, carving
  "600x600": [1, 1, 0, 0]   // Kolejno: polished, lappato, matt, carving
};
...
loadSketchfab("64b60d8b77524ca4b8ca51214933aa20", "api-frame");